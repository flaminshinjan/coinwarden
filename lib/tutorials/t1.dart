import 'package:coinwarden/tutorials/t2.dart';
...
class T1Page extends StatelessWidget {
  const T1Page({super.key});
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20),
                  Image.asset("assets/addblock.png", width: 239),
                ],
              ),
            ),
            Spacer(),
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const T2Page()),
                  );
                },
                imagepath: "assets/bcbutton.png",
                width: 341,
                height: 186,
              ),
            )
