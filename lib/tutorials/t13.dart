import 'package:coinwarden/tutorials/t14.dart';
...
class T13Page extends StatelessWidget {
  const T13Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T14Page()),
                  );
                },
                imagepath: "assets/effect.png",
                width: 341,
                height: 324,
              ),
            )
