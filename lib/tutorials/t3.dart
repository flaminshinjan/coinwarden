import 'package:coinwarden/tutorials/t4.dart';
...
class T3Page extends StatelessWidget {
  const T3Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T4Page()),
                  );
                },
                imagepath: "assets/index.png",
                width: 341,
                height: 186,
              ),
            )
