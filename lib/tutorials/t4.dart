import 'package:coinwarden/tutorials/t5.dart';
...
class T4Page extends StatelessWidget {
  const T4Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T5Page()),
                  );
                },
                imagepath: "assets/hash.png",
                width: 341,
                height: 186,
              ),
            )
