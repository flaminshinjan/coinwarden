import 'package:coinwarden/tutorials/t16.dart';
...
class T15Page extends StatelessWidget {
  const T15Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T16Page()),
                  );
                },
                imagepath: "assets/addvalid.png",
                width: 341,
                height: 305,
              ),
            )
