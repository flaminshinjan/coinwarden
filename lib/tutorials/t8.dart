import 'package:coinwarden/tutorials/t9.dart';
...
class T8Page extends StatelessWidget {
  const T8Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T9Page()),
                  );
                },
                imagepath: "assets/prevhash.png",
                width: 341,
                height: 186,
              ),
            )
