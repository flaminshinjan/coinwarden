import 'package:coinwarden/tutorials/t15.dart';
...
class T14Page extends StatelessWidget {
  const T14Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T15Page()),
                  );
                },
                imagepath: "assets/adding.png",
                width: 341,
                height: 186,
              ),
            )
