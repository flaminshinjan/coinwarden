import 'package:coinwarden/tutorials/t7.dart';
...
class T6Page extends StatelessWidget {
  const T6Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T7Page()),
                  );
                },
                imagepath: "assets/valid.png",
                width: 341,
                height: 241,
              ),
            )
