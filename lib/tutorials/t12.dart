import 'package:coinwarden/tutorials/t13.dart';
...
class T12Page extends StatelessWidget {
  const T12Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T13Page()),
                  );
                },
                imagepath: "assets/mutation.png",
                width: 341,
                height: 238,
              ),
            )
