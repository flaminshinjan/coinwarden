import 'package:coinwarden/tutorials/t6.dart';
...
class T5Page extends StatelessWidget {
  const T5Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => T6Page()),
                  );
                },
                imagepath: "assets/timestamp.png",
                width: 341,
                height: 372.54,
              ),
            )
