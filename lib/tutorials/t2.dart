import 'package:coinwarden/tutorials/t3.dart';
...
class T2Page extends StatelessWidget {
  const T2Page({super.key});
            ...
            Padding(
              ...
              child: ImageButton2(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const T3Page()),
                  );
                },
                imagepath: "assets/blockbutton.png",
                width: 341,
                height: 186,
              ),
            )
